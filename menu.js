...
const pizza = {
    ...
    popularity : 10,
    rating : 10,
    tags : ['yummy', 'cheesy', 'value', 'family favorite']
}
...
const foodArr = [
    ...
    },
    {
        ...
        popularity : 10,
        rating : 10,
        tags : ['yummy', 'flavor', 'value', 'family favorite']
    },
    {
    ...
    },
    {
        ...
        popularity : 10,
        rating : 10,
        tags : ['yummy', 'original', 'value', 'family favorite']
        },
]
...
const filteredFood = foodArr.filter(meal => meal.tags.includes('pineapple'))
